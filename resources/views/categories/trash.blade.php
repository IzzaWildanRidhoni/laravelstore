        ...
        <div class="col-md-6">
            <form action="{{ route('categories.index') }}">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Filter by name" value="{{Request::get('name')}}" name="name">
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('categories.delete-permanent', [$category->id]) }}" class="d-inline" method="POST" onsubmit="return confirm('detele this category permanently?')">
                                    @csrf
