...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <select name="categories[]" id="categories" multiple class="form-control"></select><br><br>
            ...
            <input type="number" value="{{old('price')}}" class="form-control" name="price" id="price" placeholder="Book price" class="form-control {{$errors->first('price') ? "is-invalid" : ""}} ">
            <div class="invalid-feedback">
                {{$errors->first('price')}}
            </div>  
            <br>
